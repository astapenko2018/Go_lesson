...
func main() {
	var tst myBytes
	_, err1 := io.WriteString(&tst, "Пустой интерфейс не имеет методов, следовательно, не накладывает никаких ограничений на принимаемое значение")
	if err1 != nil {
